...
export default function Home() {
  ...
  return (
    <div className="min-h-screen relative">
      <AnimatedBackground images={selectedIcons} />
        ...
        <HomeClient>
          ...
          <section id="about" className="bg-dark-bg/90 py-20 px-4 flex flex-col items-center text-center relative overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center justify-center relative z-10">
              ...
              <RecommendButtonClient 
                className="bg-neon-pink hover:bg-neon-pink/80 text-white font-pixel text-xl px-10 py-4 rounded-full shadow-[0_0_32px_rgba(255,42,109,0.6)] hover:shadow-[0_0_48px_rgba(255,42,109,0.9)] transition-all hover:scale-110 border-2 border-neon-pink/50 flex items-center gap-3"
              >
                <span className="animate-pulse">✨</span> RECOMMEND ART
              </RecommendButtonClient>
            </div>
          </section>
          <Footer />
