/**
 * Script pour uploader spécifiquement les images de 𝑆ℎ𝑖𝑖𝑛𝑎 𝑀𝑎ℎ𝑖𝑟𝑢
 * avec un nom de dossier sanitized pour Cloudinary
 */
...
async function uploadShiinaImages() {
  const wallpapersDir = path.join(process.cwd(), 'public', 'wallpapers');
  const characterName = '𝑆ℎ𝑖𝑖𝑛𝑎 𝑀𝑎ℎ𝑖𝑟𝑢';
  ...
  const sanitizedFolderName = 'shiina-mahiru'; // Use a simple, valid name
...
uploadShiinaImages().catch(console.error);
