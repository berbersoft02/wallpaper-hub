/**
 * Script pour uploader spécifiquement les images de Yuuko Hiragi
 */
...
async function uploadYuukoImages() {
  const wallpapersDir = path.join(process.cwd(), 'public', 'wallpapers');
  const characterName = 'Yuuko Hiragi';
...
`);
  ...
  const sanitizedFolderName = 'yuuko-hiragi';
...
uploadYuukoImages().catch(console.error);
